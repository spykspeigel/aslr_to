...
IF(NOT EXISTS "/home/sp/Documents/aslr_to/unittest/install_manifest.txt")
  MESSAGE(FATAL_ERROR "Cannot find install manifest:\"/home/sp/Documents/aslr_to/unittest/install_manifest.txt\"")
ENDIF(NOT EXISTS "/home/sp/Documents/aslr_to/unittest/install_manifest.txt")
...
FILE(READ "/home/sp/Documents/aslr_to/unittest/install_manifest.txt" files)
...
ENDFOREACH(file)
EXECUTE_PROCESS(
  COMMAND "/usr/bin/cmake" -E remove "/home/sp/Documents/aslr_to/unittest/install_manifest.txt"
  RESULT_VARIABLE rm_resval
  OUTPUT_VARIABLE rm_out
  ERROR_QUIET
  )
