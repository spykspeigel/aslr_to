...
acrobotResidual = aslr_to.ResidualModelDoublePendulum(state, nu)
goalTrackingCost = crocoddyl.CostModelResidual(state, acrobotResidual)
...
# runningModel.u_lb = np.array([ -4, -4])
# runningModel.u_ub = np.array([ 4, 4])
q0 = np.array([-.01,0])
