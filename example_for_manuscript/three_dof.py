...
if WITHDISPLAY and WITHPLOT:
    display = crocoddyl.GepettoDisplay(three_dof, 4, 4, cameraTF)
...
if WITHDISPLAY:
    display = crocoddyl.GepettoDisplay(three_dof)
...
print('Initial position = ', solver.problem.runningDatas.tolist()[0].differential.multibody.pinocchio.oMf[robot_model.getFrameId("EE")].translation.T)


print('Finally reached = ', solver.problem.terminalData.differential.multibody.pinocchio.oMf[robot_model.getFrameId("EE")].translation.T)
...
savemat("optimised_trajectory.mat", {"q1": q1,"q2":q2, "q3": q3,"qm1": qm1,"qm2":qm2,"qm3": qm3,"v1": v1,"v2":v2,"v3": v3,"vm1": vm1,"vm2":vm2,"vm3": vm3,"t":t})
savemat("controls.mat", {"u1": u1,"u2":u2,"u3":u3,"t":t})
